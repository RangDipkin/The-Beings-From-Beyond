...
public class ObjectTemplate extends GameObject { 
    public ObjectTemplate(String name, ImageRepresentation ir, boolean blocking, 
    ...
    public PlacedObject toPlacedObject(Location loc) {
        PlacedObject placedObject = PlacedObject.placedObjectWrapper(name, ir, 
                blocking, grabbable, precedence, loc);
        return placedObject;
    }
}